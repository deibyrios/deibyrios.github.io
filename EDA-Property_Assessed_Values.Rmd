...
The detailed analysis can be found in [EDA - Property Market Values](shapes.html), but we found inconclusive results with regards to whether the 2nd Ave Line project has affected Market Value for properties located in the vicinity to the 2nd Ave Line.
